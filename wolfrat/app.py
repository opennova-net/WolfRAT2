"""
WolfRAT 2.5.8 - Modern Joint Operations Server Admin Tool
...
class MainWindow(QMainWindow):
    ...
    def __init__(self, runtime: DesktopRuntime | None = None):
        ...
        self.setWindowTitle("WolfRAT 2.5.8 - Joint Operations Server Admin")
        ...
        self.signals.disconnected_signal.connect(lambda: self.setWindowTitle("WolfRAT 2.5.8 - Joint Operations Server Admin"))
    ...
    def _update_title(self, server_name=""):
        ...
        if server_name:
            self.setWindowTitle(f"WolfRAT 2.5.8 \u2014 {server_name}")
        else:
            self.setWindowTitle("WolfRAT 2.5.8 - Joint Operations Server Admin")
    ...
    def _build_ui(self):
        ...
        ver_label = QLabel("v2.5.8 · Built by BadgerLove · FMJ Squad")
...
def start_desktop(
    ...
    app.setApplicationName("WolfRAT 2.5.8")
...
def main(argv=None, runtime: DesktopRuntime | None = None):
    ...
    wire_log("=== WolfRAT 2.5.8 STARTED ===")
